...
#    Updated: 2023/05/20 07:52:39 by junyojeo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ifdef WITH_BONUS
	...
	ft_strdup_bonus.c ft_strjoin_bonus.c ft_strlen_bonus.c ft_strncmp_bonus.c ft_strcmp.bonus.c ft_substr_bonus.c get_next_line.c ft_strchr_bonus.c)
	NAME			=	checker
else
	SRC_DIR			=	sources
